...
| F-07 | `automated-test-harness`       | (foundation) a test runner that gates CI, and an access boundary proven by tests rather than by hand                                        | F-01, S-01       | NFR-privacy, Access Control                         | in-progress (phases 1-5 of 6) |
...
- **Change ID:** `automated-test-harness` — rollout phases live in `context/foundation/test-plan.md` §3; Phase 1 shipped as `context/archive/2026-09-07-testing-runner-and-access-boundary/`, Phase 3 as `context/changes/testing-ai-boundary-job-states/`
...
| F-07       | `automated-test-harness`       | Test runner that gates CI + an access boundary proven by tests                            | in progress           | Phases 1–5 of 6 shipped (`2026-09-07-testing-runner-and-access-boundary`; `testing-ai-boundary-job-states`; `testing-input-boundary-and-prompt-composition`; CI gate `9257f8e`). Phase tracking lives in `test-plan.md` §3, not here. Linear GRA-26                                                                            |
